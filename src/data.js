...
export const faq = [
  {q:'Bagaimana cara checkout?', a:'Pilih produk, masukkan ke keranjang, buka checkout, lalu buat invoice pembayaran.'},
  {q:'Apakah bisa bayar QRIS?', a:'Bisa. Sistem menyediakan QRIS Madhayana Market dan template DANA QRIS MPM.'},
  {q:'Bagaimana cara deposit?', a:'Buka halaman Deposit, pilih nominal, lalu bayar melalui invoice QRIS.'},
  {q:'Bagaimana cek status pesanan?', a:'Buka chatbot, pilih Cek Pesanan, lalu masukkan nomor invoice.'},
  {q:'Apakah komentar bisa pakai foto/video?', a:'Bisa. Di halaman detail produk, pengguna dapat menambahkan URL foto atau video.'}
];

export const productsSeed = [
 {id:'p1', name:'Voucher Game Premium', category:'Voucher', type:'Digital', price:25000, stock:99, rating:4.9, image:'https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=900&auto=format&fit=crop', desc:'Voucher game instan untuk top up dan kebutuhan hiburan digital.', media:['https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=900&auto=format&fit=crop'], comments:[{name:'Rama', text:'Proses cepat, invoice jelas.', rating:5, media:''}]},
 {id:'p2', name:'Paket Desain Logo UMKM', category:'Jasa', type:'Jasa Kreatif', price:150000, stock:25, rating:4.8, image:'https://images.unsplash.com/photo-1558655146-364adaf25c48?q=80&w=900&auto=format&fit=crop', desc:'Desain logo modern untuk brand, toko online, dan usaha kecil.', media:['https://images.unsplash.com/photo-1626785774625-0b1c2c4eab67?q=80&w=900&auto=format&fit=crop'], comments:[{name:'Ayu', text:'Cocok untuk UMKM.', rating:5, media:''}]},
...
export const promos = [
 {title:'Flash Promo Digital', sub:'Voucher, jasa, kelas, PPOB, software.', cta:'Belanja Sekarang', target:'home'},
 {title:'Deposit Saldo Mudah', sub:'Top up saldo ada di halaman khusus.', cta:'Deposit', target:'deposit'},
 {title:'QRIS Cepat', sub:'Invoice dan pembayaran ada di halaman khusus.', cta:'Checkout', target:'checkout'}
];
